...
void SizukuSkill::UpdateSpecialAttack(const Transform& playerTransform) {
	if (isSpecialEnd_) {
		return;
	}
...
void SizukuSkill::StartSpecialAttack(const Transform& playerTransform, int iceCount) {
	specialTransform_ = playerTransform;
...
void SizukuSkill::DrawSpecialAttack() {
	if (!iceFlowers_) {
		return;
	}
