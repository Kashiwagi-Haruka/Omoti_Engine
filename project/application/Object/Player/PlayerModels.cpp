...
const Parameter& PlayerModels::GetCurrentParameter() const {
	static const Parameter emptyParameter{};
	return currentCharacter_ ? currentCharacter_->GetParameter() : emptyParameter;
}